...
chat_data = [
    ...
    {"question": "Vocês oferecem entrega?", "answer": "Sim, oferecemos entrega gratuita para pedidos acima de R$ 100."},
    # Adicione mais pares de perguntas e respostas conforme necessário
]
